...
<header>
    <nav class="navbar">
        <a href="#"><img src="./assets/img/navbar-logo.png" alt="Logo da Vinheria Agnello" width="125px"></a>
    ...
    <div class="product-section">
        ...
        <div class="product-winesection">
            <div class="wine-firstsection">
                ...
                <div class="price-av">
                    <p>R$ 197,85</p>
                    <img src="./assets/img/product-av.png" alt="">
                </div>
            </div>
            <div class="wine-secondthird">
                <div class="wine-secondsection">
                    ...
                    <div>
                        <h3>Sabores:</h3>
                        <img src="./assets/img/wine-flavours.png" alt="">
                    </div>
                    <div>
                        <button class="add-product">
                            <img src="./assets/img/cart-white.png" alt="">
                ...
                <div class="wine-thirdsection">
                    <h3>Ficha Técnica:</h3>
                    <div class="wine-tec">
                        <img src="./assets/img/wine-info1.png" alt="">
                        <img src="./assets/img/wine-info2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="comments-section-title">
                ...
                <div>
                    <div class="avaliation">
                        <span>4.2</span>
                        <img src="./assets/img/comments-img.png" alt="">
                    </div>
